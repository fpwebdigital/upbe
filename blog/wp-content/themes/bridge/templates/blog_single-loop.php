			...
			<div class="post_content_holder">
				...
				<div class="post_text">
					<div class="post_text_inner">
						...
						<div class="post_info">
							<span class="time"><?php _e('Enviado','qode'); ?> <?php the_time('H:i'); ?><?php _e('h','qode'); ?></span>
							...
							<?php if($blog_hide_comments != "yes"){ ?>
								<span class="dots"><i class="fa fa-square"></i></span><a itemprop="url" class="post_comments" href="<?php comments_link(); ?>" target="_self"><?php comments_number('0 ' . __('Comentários','qode'), '1 '.__('Comentário','qode'), '% '.__('Comentários','qode') ); ?></a>
							<?php } ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="post_content_holder">
				<div class="post_text">
					<div class="post_text_inner">
						<div class="post_info">
							<span class="time"><?php _e('Enviado','qode'); ?> <?php the_time('d M, H:i'); ?><?php _e('h','qode'); ?></span>
							<?php _e('in','qode'); ?> <?php the_category(', '); ?>
							<span class="post_author">
								<?php _e('by','qode'); ?>
								<a itemprop="author" class="post_author_link" href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php the_author_meta('display_name'); ?></a>
					...
					<div class="post_text_inner">
                        ...
                        <div class="post_info">
                           ...
                           <span class="post_author">
                            ...
                            <span class="calend-post" style="margin-left: 20px;"><i class="qode_icon_font_awesome fa fa-calendar-o" style="font-size: 23px;color: #da291c;"></i> <span itemprop="dateCreated" class="date entry_date updated"><?php the_time('d-m-Y'); ?></span>
...
<?php if($blog_author_info == "yes") { ?>
	<div class="author_description" style="display: none">
