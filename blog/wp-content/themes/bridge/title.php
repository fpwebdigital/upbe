...
$separator_classes = array('separator', 'small');
...
$separator_classes[] = $separator_title_position;

if(get_post_meta($id, "qode_title_gradient_separator_meta", true) == "yes"){
	$separator_classes[] = 'qode-type1-gradient-left-to-right';
} elseif(isset($qode_options_proya['title_gradient_separator']) && $qode_options_proya['title_gradient_separator'] == 'yes' && get_post_meta($id, "qode_title_gradient_separator_meta", true) != "no"){
	$separator_classes[] = 'qode-type1-gradient-left-to-right';
}
...
if(!qode_is_title_hidden()) { ?>
	<div class="title_outer <?php echo $animate_title_class.$title_text_shadow; if($responsive_title_image == 'yes' && $show_title_image == true){ echo ' with_image'; }?>" style="height: 384px; margin-bottom: 40px;  background-size:2000px auto; background-image:url(http://upbe.me/blog/wp-content/uploads/2017/11/top-blog.jpg); background-position: top center;"  <?php print $animation; ?>  <?php echo 'data-height="'.$title_height.'"'; if($title_height != '' && $animate_title_area == 'area_top_bottom'){ echo 'style="opacity:0;height:' . $header_height_padding .'px;"'; } ?>>
