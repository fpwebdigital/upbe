...
if(!qode_is_title_hidden()) { ?>
	<div class="title_outer <?php echo $animate_title_class.$title_text_shadow; if($responsive_title_image == 'yes' && $show_title_image == true){ echo ' with_image'; }?>" style="height: 620px; margin-bottom: 40px; background-size:2000px auto; background-image:url(http://upbe.me/blog/wp-content/uploads/2017/11/top-blog.jpg); "  <?php print $animation; ?>  <?php echo 'data-height="'.$title_height.'"'; if($title_height != '' && $animate_title_area == 'area_top_bottom'){ echo 'style="opacity:0;height:' . $header_height_padding .'px;"'; } ?>>
